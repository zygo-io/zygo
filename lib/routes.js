...
export function getHandler(route) {
  ...
  .then((module) => {
    ...
    .then(() => {
      ...
      if (module.default.clientHandler) return System.import(module.default.clientHandler);
      return null;
    })
    .then((handler) => {
      //if not, fallback onto the handler
      if (handler) return handler;
      if (module.default.handler) return System.import(module.default.handler);
      return null;
    });
  });
}
