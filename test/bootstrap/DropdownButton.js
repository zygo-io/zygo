...
var DropdownButton = React.createClass({
  ...
  render: function() {
    ...
    return this[renderMethod]([React.createElement(Button, React.__spread({}, this.props, {
      ref: "dropdownButton",
      ...
      pullRight: null,
      dropup: null
    }), this.props.title, ' ', React.createElement("span", {className: "caret"})), React.createElement(DropdownMenu, {
      ref: "menu",
  ...
  renderNavItem: function(children) {
    ...
    return (React.createElement("li", {className: classSet(classes)}, children));
  },
